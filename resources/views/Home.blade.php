            ...
            <div class="jt_row jt_row-fluid row">
                ...
                <div class="col-md-6 col-md-offset-3 jt_col column_container">
                    <div class="section-subtitle">
                        Ofrecer al usuario lectores, un servicio de calidad, que se
                         desarrolle en un ambiente propicio para disfrutar de la mejor
                          manera y los mejores platillos y recetas que se muestran en la
                           página a una relación de calidad e imagen excelente para satisfacer
                            las necesidades y deseos de nuestros usuarios.
                    </div>
                </div>


                <div class="col-md-6 jt_col column_container">
                    <h2 class="heading font-smoothing">Espagueti rojo con cremas</h2>
                    <p class="text">
                        This <strong>Espagueti rojo con crema</strong> 
                        Un buen spaguetti para esos paladares exigentes como es el de los niños mi hija le gusta mucho que hasta repite plato.
                    </p>
                ...
                <div class="col-md-6 jt_col column_container">
                    ...
                    <div id="owl-about" class="owl-carousel">
                        <div class="item"><img src="{{url('static/images/spa.jpg')}}" alt=""></div>
                        <div class="item"><img src="{{url('static/images/spa.jpg')}}" alt=""></div>
                        <div class="item"><img src="{{url('static/images/spa.jpg')}}" alt=""></div>                        
                    </div>
                </div>
